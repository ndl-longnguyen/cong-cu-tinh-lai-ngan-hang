  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-foreground mb-4">Công cụ tính toán</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Các công cụ tính lãi suất chuyên nghiệp giúp bạn lên kế hoạch tài
              chính hiệu quả
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-foreground mb-4">Ngân hàng hỗ trợ</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Tra cứu lãi suất từ các ngân hàng lớn nhất Việt Nam
            </p>
          </div>
